...
class LivroDBOpener(context : Context) : SQLiteOpenHelper(context, LivroContrato.DATABASE_NAME, null, LivroContrato.DATA_BASE_VERSION) {
    ...
    " ${LivroContrato.LivroEntry.NOME_LIVRO} TEXT," +
    ...
    fun insert (L:Livro){
        ...
        try {
            ...
            values.put(LivroContrato.LivroEntry.NOME_LIVRO, L.nome)
    ...
    fun findById(id:Int):Livro{
        ...
        try {
            ...
            livro.nome = cursor.getString(cursor.getColumnIndex(LivroContrato.LivroEntry.NOME_LIVRO))
